...
\r
the document\u2019s head =`),$=o("head"),$.textContent="This is the document head",N=m(`\r
\r
a single line break = `),j=o("br"),F=m(`\r
also\r
`),A=o("hr"),I=m(`\r
\r
...
\r
a multiline input control (text area) =`),q=o("textarea"),he=m(`\r
\r
a table =\r
`),D=o("table"),D.textContent="This is a table",je=v(),G=o("table"),G.innerHTML='<th class="svelte-ayl5u2">This is a table header</th><tr>Row</tr><td class="svelte-ayl5u2">Cell</td>',Ae=m(`\r
\r
a drop-down list =`),h=o("select"),M=o("option"),M.textContent="This is a dropdown list",Q=o("option"),Q.textContent="option 1",R=o("option"),R.textContent="option 2",Ne=m(`\r
\r
...
\r
a cell in a table =\r
`),Z=o("table"),Z.innerHTML='<tr><td class="svelte-ayl5u2">This is a cell in a table</td></tr>',_(u,"href","http://google.com"),mt(B.src,lt="/src/assets/svelte.svg")||_(B,"src",lt),_(B,"alt","svelte logo"),_(Y,"type","I"),K.__value="",K.value=K.__value,_(V,"name",""),_(V,"id",""),_(z,"class","svelte-ayl5u2"),_(q,"name",""),_(q,"id",""),_(q,"cols","30"),_(q,"rows","10"),q.value="This is a text area",_(D,"class","svelte-ayl5u2"),_(G,"class","svelte-ayl5u2"),M.__value="",M.value=M.__value,M.disabled=!0,M.hidden=!0,M.selected=!0,Q.__value="",Q.value=Q.__value,R.__value="",R.value=R.__value,_(h,"name",""),_(h,"id",""),_(X,"type","button"),X.value="This is a button input control",_(U,"type","color"),_(U,"name","This is a color input control"),_(U,"id",""),_(W,"type","file"),_(W,"name","This is a file input control"),_(W,"id",""),_(Z,"class","svelte-ayl5u2")},m(e,s){l(e,i,s),l(e,u,s),l(e,f,s),l(e,r,s),l(e,p,s),l(e,a,s),l(e,b,s),l(e,c,s),l(e,d,s),l(e,C,s),l(e,y,s),l(e,T,s),l(e,w,s),l(e,$,s),l(e,N,s),l(e,j,s),l(e,F,s),l(e,A,s),l(e,I,s),l(e,S,s),l(e,J,s),l(e,H,s),l(e,P,s),l(e,E,s),l(e,L,s),l(e,O,s),l(e,be,s),l(e,te,s),l(e,Ce,s),l(e,ne,s),l(e,Te,s),l(e,le,s),l(e,$e,s),l(e,Le,s),l(e,ke,s),l(e,B,s),l(e,we,s),l(e,ie,s),l(e,Se,s),l(e,Y,s),l(e,Me,s),l(e,V,s),x(V,K),l(e,He,s),l(e,se,s),l(e,Ee,s),l(e,z,s),l(e,Oe,s),l(e,oe,s),l(e,qe,s),l(e,q,s),l(e,he,s),l(e,D,s),l(e,je,s),l(e,G,s),l(e,Ae,s),l(e,h,s),x(h,M),x(h,Q),x(h,R),l(e,Ne,s),l(e,ue,s),l(e,Fe,s),l(e,re,s),l(e,Ie,s),l(e,fe,s),l(e,Je,s),l(e,pe,s),l(e,Pe,s),l(e,ae,s),l(e,Be,s),l(e,de,s),l(e,Ve,s),l(e,me,s),l(e,Ke,s),l(e,X,s),l(e,Qe,s),l(e,U,s),l(e,Re,s),l(e,W,s),l(e,Ue,s),l(e,Z,s),We||(it=xt(S,"click",wt),We=!0)},p:k,i:k,o:k,d(e){e&&n(i),e&&n(u),e&&n(f),e&&n(r),e&&n(p),e&&n(a),e&&n(b),e&&n(c),e&&n(d),e&&n(C),e&&n(y),e&&n(T),e&&n(w),e&&n($),e&&n(N),e&&n(j),e&&n(F),e&&n(A),e&&n(I),e&&n(S),e&&n(J),e&&n(H),e&&n(P),e&&n(E),e&&n(L),e&&n(O),e&&n(be),e&&n(te),e&&n(Ce),e&&n(ne),e&&n(Te),e&&n(le),e&&n($e),e&&n(Le),e&&n(ke),e&&n(B),e&&n(we),e&&n(ie),e&&n(Se),e&&n(Y),e&&n(Me),e&&n(V),e&&n(He),e&&n(se),e&&n(Ee),e&&n(z),e&&n(Oe),e&&n(oe),e&&n(qe),e&&n(q),e&&n(he),e&&n(D),e&&n(je),e&&n(G),e&&n(Ae),e&&n(h),e&&n(Ne),e&&n(ue),e&&n(Fe),e&&n(re),e&&n(Ie),e&&n(fe),e&&n(Je),e&&n(pe),e&&n(Pe),e&&n(ae),e&&n(Be),e&&n(de),e&&n(Ve),e&&n(me),e&&n(Ke),e&&n(X),e&&n(Qe),e&&n(U),e&&n(Re),e&&n(W),e&&n(Ue),e&&n(Z),We=!1,it()}}}function wt(){alert("You pressed me!")}class St extends nt{constructor(i){super(),tt(this,i,null,kt,ge,{})}}function Mt(t){let i,u,f,r,p;return u=new Lt({}),r=new St({}),{c(){i=o("main"),ft(u.$$.fragment),f=v(),ft(r.$$.fragment)},m(a,b){l(a,i,b),Xe(u,i,null),x(i,f),Xe(r,i,null),p=!0},p:k,i(a){p||(Ge(u.$$.fragment,a),Ge(r.$$.fragment,a),p=!0)},o(a){rt(u.$$.fragment,a),rt(r.$$.fragment,a),p=!1},d(a){a&&n(i),Ze(u),Ze(r)}}}class Ht extends nt{constructor(i){super(),tt(this,i,null,Mt,ge,{})}}new Ht({target:document.getElementById("app")});
